...
(function (obj) {
    ...
    var logstyle = "color: #39c; font-size: 14px, font-weight: bold";

    obj.ConvivaHtml5Http = function() {

        function _constr() {
            // nothing to initialize
            this.loggedXHRCORSError = false;
        }
        ...
        // use of CodeLoader's createCORSRequest() would be nice here to avoid code duplication,
        // but it really should be a static method or moved to a utility
        // (i.e., we need to instantiate a CodeLoader just to use that method, which is a bit wasteful)
        this.makeRequestStandard = function (httpMethod, url, data, contentType, timeoutMs, callback) {
            ...
            if ('withCredentials' in xmlHttpReq) {
                ...
                xmlHttpReq.open(httpMethod, url);
            } else {
                // CORS not supported.
                xmlHttpReq = false;
            }

            if (!xmlHttpReq && !this.loggedXHRCORSError) {
                this.loggedXHRCORSError = true;
                console.warn("ConvivaHtml5Http: No CORS/XHR support.");
                return;
            }

            // VTG-158; lines from default implementation below are replaced by above for better XHR coverage
            // var xmlHttpReq = new XMLHttpRequest();
            // xmlHttpReq.open(httpMethod, url, true);
            ...
            xmlHttpReq.onreadystatechange = function () {
                ...
                if (xmlHttpReq.readyState === 4) {
                    ...
                    if (xmlHttpReq.status == 200) {
                        ...
                        msg = "http status " + xmlHttpReq.status;
...
(function (obj) {
    ...
    obj.ConvivaHtml5Logging = function() {
...
(function (obj) {
    ...
    obj.ConvivaHtml5Metadata = function() {
...
(function (obj) {
    ...
    obj.ConvivaHtml5Storage = function() {
...
(function (obj) {
    ...
    obj.ConvivaHtml5Timer = function() {
