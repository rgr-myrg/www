...
//import * as ADBMobile from 'adbmobile';
...
var AdbMobileAgent = /** @class */ (function (_super) {
    ...
    function AdbMobileAgent() {
        ...
        _this.ADBMobile = window.ADBMobile;
        return _this;
    }
    //ADBMobile: AdbMobileInterface = require('adbmobile');
    AdbMobileAgent.prototype.onRegister = function () {
        var _this = this;
        var _a;
        //if (typeof (<any>window).ADBMobile !== 'object') {
        if (typeof this.ADBMobile !== 'object') {
            throw ('ADBMobile library not available to the window');
            this.debug && this.logWarn('onRegister aborted');
            return;
        }
        var onError = function (e) { return _this.onError(e); };
        //this.ADBMobile = <AdbMobileInterface> (<any>window).ADBMobile;
...
var TrackingApi = /** @class */ (function (_super) {
    ...
    function TrackingApi() {
        ...
        _this.isDebug = false;
        _this.agents = [];
        _this.modelCollection = new cv_model_1.ModelCollection();
        return _this;
    }
    ...
    TrackingApi.prototype.notify = function (playerEvent) {
        if (playerEvent === cv_model_1.PlayerEvents.TRACKING_CONFIG_READY) {
            this.registerAgents();
        }
        this.emit(playerEvent);
    };
    TrackingApi.prototype.onError = function (errorInfo) {
        this.emit(cv_model_1.PlayerEvents.VIDEO_PLAYBACK_ERROR, errorInfo);
    };
